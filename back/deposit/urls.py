...
from .views import DepositProductListView, BookmarkToggleView, BookmarkListView, related_products, DepositProductDetailView
...
urlpatterns = [
    ...
    path('products/<int:pk>/', DepositProductDetailView.as_view()),
]
